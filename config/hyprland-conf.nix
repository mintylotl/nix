...
#windowrule = workspace 8 silent, ^(qBittorrent)$
#windowrule = workspace 9 silent, ^(TelegramDesktop)$
windowrule = workspace 1 silent, ^(firefox)$
#windowrule = workspace 10 silent, ^(musicbee.exe)$
...
# --Audio
bind = , F7, exec, pactl set-sink-volume alsa-base-headphones -5%
bind = , F8, exec, pactl set-sink-volume alsa-base-headphones +5%
# --Programs
